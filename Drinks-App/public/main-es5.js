...
>>>>>>> b9a09a304ab85d13392ea239b337c8488d19cbfc
  ...
  function srcAppComponentsNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NavbarComponent = /*#__PURE__*/function () {
      ...
      _createClass(NavbarComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.nav.getUserPic().subscribe(function (response) {
    ...
    NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "nav-parent", 4, "ngIf"], [1, "nav-parent"], ["routerLink", "/the-feed", 1, "feed"], ["routerLink", "/drink-post", 1, "drink-post"], ["routerLink", "/profile", 1, "profile"], ["alt", " ", "width", "100px", "height", "300px", 3, "src"], ["routerLink", "/preferences", 1, "preferences"], ["routerLink", "/quiz", 1, "quiz"]],
...
>>>>>>> b9a09a304ab85d13392ea239b337c8488d19cbfc
    ...
    function PreferencesBartendersComponent_p_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    PreferencesBartendersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 2,
      consts: [[1, "parent-container"], ["class", "child-container", 4, "ngIf"], [4, "ngIf"], [1, "child-container"], [4, "ngFor", "ngForOf"], [3, "click"]],
...
>>>>>>> b9a09a304ab85d13392ea239b337c8488d19cbfc
  ...
  function srcAppComponentsPreferencesPreferencesDrinksPreferencesDrinksComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PreferencesDrinksComponent = /*#__PURE__*/function () {
      ...
      _createClass(PreferencesDrinksComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {// this.favoriteService.getFavorites();
    ...
    PreferencesDrinksComponent.ɵfac = function PreferencesDrinksComponent_Factory(t) {
      return new (t || PreferencesDrinksComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_favorites_service__WEBPACK_IMPORTED_MODULE_2__["FavoritesService"]));
    };
  ...
  function srcAppComponentsPreferencesPreferencesHomeBarPreferencesHomeBarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PreferencesHomeBarComponent = /*#__PURE__*/function () {
      ...
      _createClass(PreferencesHomeBarComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.preferService.getItems();
          this.itemsSub = this.preferService.getItemUpdateListener().subscribe(function (items) {
            _this8.homeBar = items.filter(function (item) {
    ...
    PreferencesHomeBarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 2,
      consts: [[4, "ngIf"], ["class", "container", 4, "ngIf"], [1, "container"], [4, "ngFor", "ngForOf"], [3, "click"]],
    ...
    var PreferencesLocationsComponent = /*#__PURE__*/function () {
      ...
      _createClass(PreferencesLocationsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.preferService.getItems();
          this.itemsSub = this.preferService.getItemUpdateListener().subscribe(function (items) {
            _this9.locations = items.filter(function (item) {
...
>>>>>>> b9a09a304ab85d13392ea239b337c8488d19cbfc
  ...
  function srcAppComponentsPreferencesPreferencesMainPreferencesMainComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function PreferencesMainComponent_preferences_locations_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "preferences-locations");
      }
    }

    function PreferencesMainComponent_preferences_home_bar_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "preferences-home-bar");
      }
    }

    function PreferencesMainComponent_preferences_drinks_23_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "preferences-drinks");
      }
    }

    function PreferencesMainComponent_preferences_bartenders_24_Template(rf, ctx) {
      if (rf & 1) {
...
>>>>>>> b9a09a304ab85d13392ea239b337c8488d19cbfc
      ...
      _createClass(PreferencesService, [{
        ...
        value: function getItems() {
          ...
          this.http.get('/api/favorites', {
            ...
            console.log(data.message); // console.log(data.items);
        ...
        value: function addItems(formValue) {
          ...
          this.http.post('/api/favorites', formValue, {
            ...
            _this11.itemsUpdated.next(response.items);
          });
        } // local
        // deleteItem(itemId) {
        //   this.http
        ...
        value: function deleteItem(itemId) {
          ...
          this.http["delete"]("/api/favorites/".concat(itemId)).subscribe(function () {
            _this12.items = _this12.items.filter(function (item) {
              return item.fav_id !== itemId;
            });

            _this12.itemsUpdated.next(_toConsumableArray(_this12.items));
          });
        }
      }]);
  ...
  function srcAppComponentsPreferencesSavedDrinksSavedDrinksComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SavedDrinksComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 1,
      consts: [[1, "background-img"], ["class", "details", 4, "ngFor", "ngForOf"], [1, "details"], [1, "name"], ["routerLink", "/preferences"], [1, "info"], [1, "how"]],
      ...
      _createClass(RecipeDetailsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.recipeAPI.getDetails(this.recipeID).subscribe(function (data) {
            ...
            console.log('details', _this17.recipes);
          });
        }
      }]);
    ...
    var RecipeMainComponent = /*#__PURE__*/function () {
      ...
      _createClass(RecipeMainComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.recipeApi.getRandom().subscribe(function (data) {
            _this18.recipes = data['drinks']; // console.log(this.recipes);
          });
        }
      }, {
        key: "nameSearch",
...
>>>>>>> b9a09a304ab85d13392ea239b337c8488d19cbfc
  ...
  function srcAppComponentsRecipeBookRecipeSearchRecipeSearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function RecipeSearchComponent_option_17_Template(rf, ctx) {
      if (rf & 1) {
      ...
      _createClass(RecipeSearchComponent, [{
        ...
        value: function searchByName() {
          ...
          this.recipeAPI.searchByName(this.nameSearch.value).subscribe(function (data) {
            return _this19.searchResults.emit(data['drinks']);
          });
        }
      }, {
        key: "searchByLetter",
        value: function searchByLetter() {
          ...
          this.recipeAPI.searchByLetter(this.letterSearch.value).subscribe(function (data) {
            _this20.searchResults.emit(data['drinks']);
          });
        }
      }, {
        key: "resetForm",
    ...
    RecipeSearchComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 20,
      vars: 3,
      consts: [[1, "global-parent"], ["routerLink", "/preferences"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["type", "text", "placeholder", "Search by Name", "formControlName", "searchName"], ["type", "submit"], [1, "form-group2"], ["for", "alphabet"], ["formControlName", "letter", "name", "letter", "id", "letter"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]],
      template: function RecipeSearchComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function RecipeSearchComponent_Template_form_ngSubmit_10_listener() {
      ...
      _createClass(TheFeedPostsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.postService.getAllPosts().subscribe(function (data) {
            _this21.theFeed = data;
            console.log(_this21.theFeed);
          });
        }
      }, {
        key: "toggle",
      ...
      _createClass(UserProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.drinkPosts.getUserPosts().subscribe(function (data) {
            ...
            _this22.posts = data.items;
            console.log('this.posts', _this22.posts);
          });
          this.userService.getUsers().subscribe(function (data) {
            _this22.userInfo = data.users; // console.log(this.userInfo);
          });
        }
      }, {
        key: "logOut",
      ...
      _createClass(UserRecipesCreateComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userRecipe.valueChanges.subscribe(function (value) {
            _this24.ratingDisplay = value.rating;
          });
        } // removeIngredient(i) {
        ...
        value: function getLocation() {
          ...
          navigator.geolocation.getCurrentPosition(function (position) {
            _this25.latitude = position.coords.latitude;
            _this25.longitude = position.coords.longitude;
          });
        }
      }]);
      ...
      _createClass(UserRecipesMainComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userRecipeService.getRecipes().subscribe(function (data) {
            _this26.recipes = data;
            console.log(_this26.recipes);
          });
        }
      }]);
    ...
    var AuthService = /*#__PURE__*/function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function saveToken(token) {
          ...
          this.decodedToken = decodedToken;
          localStorage.setItem('topShelf_token', token); // console.log('decoded token', this.decodedToken);
      ...
      _createClass(FavoritesService, [{
        ...
        value: function addToFavorites(drink) {
          ...
          this.http.post('/api/recipes', drink, {
            ...
            _this28.favorites.push(drink);

            _this28.favoritesUpdated.next(_toConsumableArray(_this28.favorites)); // console.log('service', this.favorites);
        ...
        value: function userRecipes(recipe) {
          ...
          this.http.post('/api/recipes/created', recipe, {
            ...
            _this29.favorites.push(recipe);

            _this29.favoritesUpdated.next(_toConsumableArray(_this29.favorites));

            _this29.router.navigate(['/preferences']); // console.log('service', this.favorites);
        ...
        value: function getFavorites() {
          ...
          this.http.get('/api/recipes', {
            ...
            console.log(response.message);
            _this30.favorites = response.items;
        ...
        value: function addNewUser(formValue) {
          ...
          this.http.post('/api/users/register', formValue).subscribe(function (response) {
            if (!response.goodToGo) {
              _this33.errorMessage = response.message; // console.log(this.errorMessage);

              _this33.warning = response.goodToGo; // console.log(this.warning);
            } else {
              // console.log(response.message);
